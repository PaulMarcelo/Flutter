    ...
    return Table(
      children: [
        ...
        TableRow(children: [
          ...
          _crearBotonRedondeado(
              Colors.orangeAccent, Icons.insert_drive_file, 'File'),
        ]),
        TableRow(children: [
          _crearBotonRedondeado(
              Colors.blueAccent, Icons.movie_filter, 'Entretaiment'),
          _crearBotonRedondeado(Colors.green, Icons.cloud_circle, 'Groces'),
        ]),
        TableRow(children: [
          _crearBotonRedondeado(Colors.redAccent, Icons.collections, 'Photo'),

...
import 'package:path/path.dart' as paht;
...
class ChatState extends State<Chat> {
                ...
                children: <Widget>[
                  ...
                  message.type == MessageType.text
                    ...
                    style: TextStyle(
                      ...
                      : CachedNetworkImage(
                    imageUrl: message.message, width: 150,
  ...
  _pickImages() async {
    try {
      ...
      for (Asset asset in assets) {
        final path =  asset.name;
        final ext = paht.extension(path);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        // minimiza el teclado cuando se click afuera del TextField
        FocusScope.of(context).requestFocus(FocusNode());
      },
      child: Container(
        width: size.width,
